  ...
  return (
    <div className={darkMode?"dark-mode": "app"}>
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={() => setDarkMode(prev => !prev)}>
          <FontAwesomeIcon icon={darkMode?faSun:faMoon} style={darkMode? {color:'#FFA500'}: null}/>
        </button>
